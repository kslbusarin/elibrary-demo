<?php
    ...
    if($requestMethod == 'GET'){
            ...
            //SQL select all
        //     $sql = "select borrow.bookid,book.title,book.coverfileurl,author.authorname,book.bookviewcount, count(borrow.bookid) as count  from book
        //     inner join (
        ...
        //   where book.status = true
        //   group by borrow.bookid,book.title,author.authorname,book.bookviewcount,book.coverfileurl
        //   order by count desc
        //   limit 8";
        $sql = "select book.bookid,book.title,author.authorname,book.bookviewcount,book.coverfileurl, count(borrow.bookid) as count  from book
          ...
          order by book.bookid asc limit 8";
