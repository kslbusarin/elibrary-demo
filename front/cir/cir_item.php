...
<html lang="en">
	<head>
        ...
        <script src="../js/controller/cir_item.js"></script>
		<meta charset="UTF-8" />
		<meta name="viewport"
        ...
        <div class="container py-3">
            ...
            <div class="card shadow-sm bg-white mt-5">
                <div class="d-flex justify-content-left mt-3">
                    <div class="col-12">
                        <div class="mx-4">
                            <button class="btn btn-primary btn-md" onclick="location.href = 'index.php';">รายการหนี้</button>
                            <button class="btn btn-success btn-md" >ประวัติการยืม-คืน</button>
                        </div>
                    </div>
                </div>
