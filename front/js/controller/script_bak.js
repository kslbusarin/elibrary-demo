    ...
    if(localStorage.getItem("username")!==null){
        ...
        console.log(localStorage.getItem("username"))
            if(("uid" in localStorage) && ("username" in localStorage)){
                document.getElementById("txt_username").innerHTML = "<a class='text-white' href='../dashboard'>"+localStorage.getItem("uid")+" "+localStorage.getItem("username")+"</a>";
...
function show(data) {
    ...
    <div class="card mx-0 py-2 mb-4 rounded-2 shadow-sm">
        <div class="card-body">
            <div style="height: 16em;">
                <div class="h-100 d-inline-block">
                    ...
                    <!-- img class="mh-100" src="${global_file_url_api }/demo5/pdf/${ book_detail.bookid}/${ book_detail.bookid}.png" 
        ...
        <div class=" mx-4">
            ...
            <p class="text-start text-secondary">${ sub_title(book_detail.authorname) }</p>
        </div>
        <div class="row mt-3">
            ...
            <div class="card mx-0 py-2 mb-4 rounded-2 shadow-sm">
                <div class="card-body">
                    <div style="height: 16em;">
                        <div class="h-100 d-inline-block">
                            <!-- img class="mh-100" src="${ book_detail.coverfileurl }" alt="Max-width 100%" -->
                            <!-- img class="mh-100" src="${global_file_url_api }/test_elibrary/upload/pdf/${ book_detail.bookid}/${ book_detail.bookid}.png" 
                            alt="${ book_detail.bookid }" -->
                            <!-- img class="mh-100" src="${global_file_url_api }/demo5/pdf/${ book_detail.bookid}/${ book_detail.bookid}.png" alt="${ book_detail.bookid }" -->
                            <img class="mh-100" src="${ book_detail.coverfileurl }">
                        </div>
                    </div>
                </div>
