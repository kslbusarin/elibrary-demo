...
// const api_url = global_url_api+"/test_elibrary/backend/book/book.php";
const api_url_lastestbook =
  global_url_api + "/test_elibrary/backend/book/lastestbook.php";
...
function check_authen() {
  ...
  if (username) {
    document.getElementById("txt_username").innerHTML =
      localStorage.getItem("uid") + " " + window.username;
        ...
        <div class="card-body">
            <div style="height: 16em;">
                <div class="h-100 d-inline-block">
                    ...
                    <!-- img class="mh-100" src="${global_url_api}/test_elibrary/upload/pdf/${
      book_detail.bookid
