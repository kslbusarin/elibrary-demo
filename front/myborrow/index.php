...
<html lang="en">
	<head>
        ...
        <script src="../js/controller/myborrow.js"></script>
		<meta charset="UTF-8" />
		<meta name="viewport"
        ...
        <div class="container py-3">
            ...
            <div class="card shadow-sm bg-white mt-5">
                <div class="d-flex justify-content-left mt-3">
                    <div class="col-12">
                        <div class="mx-4">
                            <button class="btn btn-primary btn-md" >หนังสือที่ยืม</button>
                            <button class="btn btn-success btn-md" onclick="gotoBorrowHistory()">ประวัติการยืม</button>
                        </div>
                    </div>
                </div>
                <div class="d-flex justify-content-center my-3">
                    <div class="col-10 table-responsive">
                        <table class="table text-center" id="myborrowTable">
